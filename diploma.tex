...
\newcommand{\vikkulsokonzulens}{Budai László}
\newcommand{\vikcim}{Modernizálás a Common Criteria alapján}
...
\lstset{
	...
	stringstyle=\tiny\ttfamily, 			% typewriter type for strings
