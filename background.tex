...
a szoftver teljesítménye mindig is elősdleges szempont volt.
...
Általában az \emph{EAL4} szint az a legmagasabb elérendő szint, amely egy már meglévő termék esetén
...
\begin{itemize}
    \item strukturált fejlesztési folyamatra,
    \item felügyelt fejlesztői környezetre,
    \item teljes automatizációra
\end{itemize}
